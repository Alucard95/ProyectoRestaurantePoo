...
public class VentanaMenuPrincipalController implements Initializable {
    ...
    @FXML
    private MenuItem realizar_cita;
    ...
    {   
        ...
        realizar_cita.setVisible(false);
    ...
    @FXML
    private void realizar_cita(ActionEvent event) throws IOException
    {         
        FXMLLoader fxmlLoader = new FXMLLoader(App.class.getResource("VentanaRegistroCita" + ".fxml"));
        Parent root = (Parent) fxmlLoader.load();
        Stage stage = new Stage();  
        VentanaMapaRestauranteController controlador = fxmlLoader.<VentanaMapaRestauranteController>getController();                                
        controlador.cargarPanelRestaurante(empleado,false);        
